            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-body pb-0">
                  ...
                  <div class="pull-in sparkline-fix">
                    <div id="lineChart2"><canvas style="display: inline-block; width: 328.2px; height: 70px; vertical-align: top;" width="328" height="70"></canvas></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card">
                <div class="card-body pb-0">
                  ...
                  <p class="text-muted">Transactions</p>
                  <div class="pull-in sparkline-fix">
                    <div id="lineChart3"><canvas style="display: inline-block; width: 328.2px; height: 70px; vertical-align: top;" width="328" height="70"></canvas></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card card-dark bg-primary-gradient">
                <div class="card-body pb-0">
                  ...
                  <div class="pull-in sparkline-fix chart-as-background">
                    <div id="lineChart4"><canvas style="display: inline-block; width: 327px; height: 70px; vertical-align: top;" width="327" height="70"></canvas></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card card-default">
                <div class="card-body pb-0">
                  ...
                  <p>New Users</p>
                  <div class="pull-in sparkline-fix chart-as-background">
                    <div id="lineChart5"><canvas style="display: inline-block; width: 327px; height: 70px; vertical-align: top;" width="327" height="70"></canvas></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card card-dark bg-success2">
                <div class="card-body pb-0">
                  ...
                  <p>Transactions</p>
                  <div class="pull-in sparkline-fix chart-as-background">
                    <div id="lineChart6"><canvas style="display: inline-block; width: 327px; height: 70px; vertical-align: top;" width="327" height="70"></canvas></div>
                  </div>
                </div>
              </div>
            </div>
